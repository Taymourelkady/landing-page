  ...
  return (
    <Card className="border-border/40 shadow-lg w-full">
      <CardHeader className="space-y-1 text-center">
        ...
        <CardDescription>Get started with TreeBI and transform your data experience</CardDescription>
      </CardHeader>
      <CardContent>
        ...
        <div className="mt-6 text-center">
          ...
          <div className="mt-6 flex items-center justify-center gap-2">
            ...
            <a href="/login" className="text-sm text-emerald-500 hover:underline">
              Log in
            </a>
          </div>
        </div>
      ...
      <CardFooter className="bg-muted/30 border-t border-border/40 flex flex-col p-4">
        <div className="flex items-center gap-2 text-sm">
          ...
          <span>Join 10,000+ data professionals using TreeBI</span>
        </div>
      </CardFooter>
    </Card>
  )
