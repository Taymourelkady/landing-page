      ...
      <div className="container relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 rounded-full bg-treeo-500/20 px-4 py-1.5 text-sm font-medium mb-6">
            <span className="text-treeo-400">Our Mission</span>
          </div>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-6 text-white">
            Making Data <span className="text-treeo-500">Consistent</span> and{" "}
            <span className="text-treeo-500">Accessible</span>
          </h1>
